...
export function HomeClient({ sitekey }: { sitekey: string }): React.JSX.Element {
  ...
  const handleSubmit = async (values: z.infer<typeof createLinkSchema>) => {
    ...
    try {
      ...
      setResultLink(`${process.env.NEXT_PUBLIC_APP_URL}/${res.data.id}`);
  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <CreateLinkForm handleSubmit={handleSubmit} isSubmitting={isSubmitting} sitekey={sitekey} />
      {resultLink && (
